...
<div class="wpsr-all-reviews" :class="reviewsWrapperClasses">
  <div :class="reponsiveClasses" v-for="(review, index) in latestReviews" :key="index">
      <div class="wpsr-review-template wpsr-review-template-four"
           :data-index="index"
      ...
      >
          <div class="wpsr-review-header" :style="template_meta.equal_height === 'true' ? { 'height': template_meta.equalHeightLen +'px' }: '' ">
                <ReviewPlatform
