<template>
    <div v-if="feed_config" class="wpsr-connection-platform wpsr-feed-connection-platform">
        ...
        <div class="wpsr-platforms-group">
            <div class="wpsr-platforms-list-group wpsr-connection-wrapper">
                <div class="wpsr-platform wpsr-platform--connection" :style="connectionCardStyle">
                    <div class="wpsr-platform-connection-row" @click="twitterSettingModal = true">
                        <img :src="assets_url+'/images/icon/icon-twitter.png'" class="image wpsr-platform-connection-icon">
                        ...
                        <span class="wpsr-platform-connection-gear" @click.stop="twitterSettingModal = true">
        ...
        <twitter-config
            v-if="twitterSettingModal"
            :twitterModal="twitterSettingModal"
            @twitter_settings="twitterSettingModal = $event"
        >
        </twitter-config>
    </div>
</template>
...
import TwitterConfig from '../../../views/platforms/feeds/Twitter';

export default {
    name: "TwitterFeedConnection",
    components: {
        FeedEditorGroup,
        UpgradeToProButton,
        Twitter,
    ...
    computed: {
        isPlatformConnected() {
            // Check if Twitter is connected based on connected_ids or other connection indicators
