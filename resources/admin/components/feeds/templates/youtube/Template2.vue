<template>
  <div>
    ...
    <div v-if="configs.dynamic.items && configs.dynamic.items.length" class="wpsr-yt-feed-wrapper wpsr-yt-feed-template2" :class="[configs.feed_settings.layout_type === 'carousel' ? 'wpsr-youtube-slider-activate' : '', 'wpsr-yt-feed-template-'+this.$route.params.template_id]">
