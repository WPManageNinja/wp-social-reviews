<template>
  <div>
    ...
    <div v-if="configs.dynamic.items && configs.dynamic.items.length" class="wpsr-yt-feed-wrapper wpsr-yt-feed-template1" :class="[configs.feed_settings.layout_type === 'carousel' ? 'wpsr-youtube-slider-activate' : '', 'wpsr-yt-feed-template-'+this.$route.params.template_id]">
      <div class="wpsr-container">
        <Header
          ...
          />
          <div class="wpsr-row" v-if="configs.feed_settings.video_settings.play_mode === 'gallery' && configs.dynamic.items && configs.dynamic.items[0] && image_settings.has_gdpr === 'false'">
