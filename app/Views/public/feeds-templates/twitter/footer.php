...
$wpsr_mt_30 = $column_gaps === 'no_gap' ? 'wpsr-mt-20' : '';
echo '<div class="wpsr-twitter-footer wpsr-row ' . esc_attr($wpsr_mt_30) . '">';

//render pagination
if ($total > $paginate && $layout_type !== 'carousel' && $pagination_type !== 'none') {
    $wpsr_load_more_button_text = $feed_settings['pagination_settings']['load_more_button_text'];
    echo '<button 
    aria-label="'.esc_attr($wpsr_load_more_button_text).'"
