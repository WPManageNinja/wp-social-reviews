...
if (!empty($reviews)) {
    ...
    foreach ($reviews as $wpsr_index => $wpsr_review) {
        ...
        ?>
            <div class="wpsr-review-template wpsr-review-template-one <?php echo ($wpsr_review->platform_name) ? 'wpsr-review-template-' . esc_attr($wpsr_review->platform_name) : ''; ?>"
            ...
            >
                ...
                ?>
                    ...
                    <div class="wpsr-review-info">
                        ...
                        do_action('wpsocialreviews/reviewer_rating', 
                            $template_meta['reviewerrating'],
                            $template_meta['rating_style'],
                            $wpsr_rating,
                            $wpsr_review->platform_name,
                            $wpsr_review->recommendation_type,
                        ...
                        if($wpsr_review->category !== 'ai_summary' && $wpsr_review->platform_name !== 'ai'){
                             ...
                             * */
                            do_action('wpsocialreviews/review_date', $template_meta['timestamp'], $wpsr_review->review_time);
                        }
