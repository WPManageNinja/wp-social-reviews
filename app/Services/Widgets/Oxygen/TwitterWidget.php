...
class TwitterWidget extends OxygenEl
{
    ...
    function name() {
        return __( "X (Twitter) Feeds", 'wp-social-reviews' );
    }
    ...
    function controls() {
        ...
        $tw_name_section->typographySection( __('Typography', 'wp-social-reviews'), '.wpsr-twitter-tweet .wpsr-twitter-author-tweet .wpsr-tweet-author-info .wpsr-tweet-author-links a.wpsr-tweet-author-name', $this );
        ...
        $tw_meta_section->typographySection( __('Typography', 'wp-social-reviews'), '.wpsr-twitter-tweet .wpsr-twitter-author-tweet .wpsr-tweet-author-info .wpsr-tweet-author-links .wpsr-tweet-author-username-time a', $this );
        ...
        $tw_des_section->typographySection( __('Typography', 'wp-social-reviews'), '.wpsr-twitter-tweet .wpsr-twitter-author-tweet .wpsr-tweet-content p', $this );
        ...
        $tw_actions_typo = $tw_actions_section->addControlSection( "wpsr_tw_actions_typo", __("Typography", "wp-social-reviews"), "assets/icon.png", $this );
        ...
        $pagination_section->typographySection( __('Typography', 'wp-social-reviews'), '.wpsr_more', $this );
    ...
    function render( $options, $defaults, $content ) {
        if( $options['wpsr_twitter'] == "no" ) {
            echo '<h5 class="wpsr-template-missing">' . esc_html__("Select a template", 'wp-social-reviews') . '</h5>';
            return;
        }
        ...
        if ( function_exists('do_oxygen_elements') ) {
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Oxygen elements are safe HTML output
            echo do_oxygen_elements('[wp_social_ninja id="'. esc_attr($options['wpsr_twitter']) .'" platform="twitter"]');
        } else {
            echo do_shortcode('[wp_social_ninja id="'. esc_attr($options['wpsr_twitter']) .'" platform="twitter"]');
        }
    }
